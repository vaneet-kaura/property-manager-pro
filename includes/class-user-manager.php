        ...
        jQuery(document).ready(function($) {
            ...
            $('#user-profile-form').on('submit', function(e) {
                ...
                $.ajax({
                    ...
                    data: {
                        ...
                        nonce: '<?php echo esc_js(wp_create_nonce('property_manager_nonce')); ?>',
            ...
            $('#confirm-delete-account').on('click', function() {
                if (!$('#confirm_delete').is(':checked')) {
                    alert('<?php esc_html_e('Please confirm that you understand this action is permanent.', 'property-manager-pro'); ?>');
                    return;
                }
                
                var password = $('#delete_password').val();
                if (!password) {
                    alert('<?php esc_html_e('Please enter your password.', 'property-manager-pro'); ?>');
                    return;
                }
                
                if (!confirm('<?php esc_html_e('Are you absolutely sure you want to delete your account?', 'property-manager-pro'); ?>')) {
                    return;
                }
